  ...
  <div class="home-container">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-icon java-icon">☕</div>
        <div class="app-info">
          <div class="app-title">Java面试官</div>
          <div class="app-desc">智能面试顾问，帮你解答面试问题</div>
        </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI超级智能体应用平台提供Java面试官和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,Java面试官,AI助手,智能对话,鱼皮,AI超级智能体,首页'
    }
  ]
})
...
.ai-title {
  ...
  margin-bottom: 10px;
  letter-spacing: 2px;
  text-shadow: 0 0 8px rgba(0,178,255,0.2);
}
