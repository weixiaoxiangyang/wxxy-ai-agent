...
// 设置页面标题和元数据
useHead({
  title: 'Java面试官 - AI超级智能体应用平台',
  meta: [
    {
      name: 'description',
      content: 'Java面试官是AI超级智能体应用平台的专业面试官，帮你解答各种面试问题，提供面试建议'
    },
    {
      name: 'keywords',
      content: 'Java面试官,面试咨询,面试建议,AI聊天,面试问题,AI智能体'
    }
  ]
})
...
const generateChatId = () => {
  return 'javaInterview_' + Math.random().toString(36).substring(2, 10)
}
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到Java面试官，请告诉我你的面试问题，我会尽力给予帮助和建议。', false)
})
